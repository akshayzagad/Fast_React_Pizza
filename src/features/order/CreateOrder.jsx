    ...
    <div>
      ...
      <Form method="post">
        ...
        <div>
          <label>Address</label>
          <div>
            <input type="text" className="rounded-full border border-stone-200 px-4 py-2 text-sm transition-all duration-300 placeholder:text-stone-400 focus:outline-none focus:ring focus:ring-yellow-400 w-full md:px-6 md:py-3" name="address" required />
          </div>
        </div>
        ...
        <div>
          ...
          <button disabled={isSubmitting} className="inline-block bg-yellow-400 uppercase font-semibold text-stone-800 py-3 px-4 tracking-wide rounded-full hover:bg-yellow-100 transition-colors duration-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:bg-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed">
